...
// ID is the common.Hash for uniquely identifying a trie.
type ID struct {
...
// StateTrieID constructs an common.Hash for state trie with the provided state root.
...
// StorageTrieID constructs an common.Hash for storage trie which belongs to a certain
...
// TrieID constructs an common.Hash for a standard trie(not a second-layer trie)
